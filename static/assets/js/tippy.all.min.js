        ...
        modifiers: {
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var p, n, s = void 0 === r ? e.gpuAcceleration : r,
                        ...
                        b = j('transform');
                    if (n = 'bottom' == f ? -d.height + m.bottom : m.top, p = 'right' == h ? -d.width + m.right : m.left, s && b) c[b] = 'translate3d(' + p + 'px, ' + n + 'px, 0)', c[f] = 0, c[h] = 0, c.willChange = 'transform';
                    else {
                        var u = 'bottom' == f ? -1 : 1,
                            y = 'right' == h ? -1 : 1;
